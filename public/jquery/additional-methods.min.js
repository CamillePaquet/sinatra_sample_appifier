 ...
 * Copyright (c) 2013 J̦rn Zaefferer; Licensed MIT */ (function () {
  function t(t) {
    return t
      .replace(/<.[^<>]*?>/g, " ")
      .replace(/&nbsp;|&#160;/gi, " ")
  ...
  jQuery.validator.addMethod(
    ...
    function (t) {
      ...
      for (e = 0; 17 > e; e++) {
        if (
          ((r = o[e]), (a = t.slice(e, e + 1)), 8 === e && (s = a), isNaN(a))
        ) {
    ...
    function (t, e) {
      ...
      if (a.test(t)) {
        var r = t.split("/"),
          ...
          d = new Date(u, s - 1, n);
        i =
          d.getFullYear() === u && d.getMonth() === s - 1 && d.getDate() === n
            ? !0
            : !1;
      } else i = !1;
  ...
  jQuery.validator.addMethod(
    ...
    function (t, e) {
      ...
      if (
        !/^([a-zA-Z0-9]{4} ){2,8}[a-zA-Z0-9]{1,4}|[a-zA-Z0-9]{12,34}$/.test(t)
      )
        return !1;
      ...
      for (
        ...
        (u = d.charAt(h)),
          "0" !== u && (l = !1),
          l || (o += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(u));
  ...
  jQuery.validator.addMethod(
    ...
    function (t, e, i) {
      return this.optional(e)
        ? !0
        : ("string" == typeof i && (i = RegExp("^(?:" + i + ")$")), i.test(t));
    },
    "Invalid format."
  ),
  jQuery.validator.addMethod(
